...
module.exports = {
	VERSION: 'v4.4.1', 
    SESSION_ID: process.env.SESSION_ID || '06_17_H_E_R_M_I_T_6V24H80',
    ...
    BOT_INFO: process.env.BOT_INFO || 'silva;tech;254743706010;https://i.imgur.com/6oRG106.jpeg',
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '254743706010,0',
       DEBUG: DEBUG
};
